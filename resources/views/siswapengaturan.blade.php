        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="d-flex items-center align-items-center">
                    ...
                    {{-- Upload Profile Form --}}
                    <form action="{{ route('action.upload_profile_new', ['id' => $user->user_id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                    ...
                    <form action="{{route('action.delete_profile_new', ['id' => $user->user_id])}}" method="POST">
                ...
                <form action="{{route('siswa.update-pengaturan')}}" class="my-4 row gap-3" method="POST">
                    @csrf
                    @method('PATCH')
