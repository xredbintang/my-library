                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row mb-5">
                            <div class="col-12 text-center">
                                <img src="{{ asset('storage/pengembang/imgsiswa.jpeg') }}" alt="foto dashboard perpus" class="img-fluid mb-4" style="max-width: 750px; height: auto; border-radius: 10px;">
                            </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-md-3 text-center">
                                <img src="{{ asset('storage/pengembang/pengembang.jpg') }}" alt="Foto Pengembang" class="img-fluid" style="max-width: 200px; height: auto; border-radius: 10px;">
                            </div>
                            <div class="col-md-9">
